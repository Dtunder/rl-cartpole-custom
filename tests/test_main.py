...
def test_env_step_sinusoidal_wind():
...
def test_env_termination():
    ...
    env.state = (0.0, 0.0, env.theta_threshold_radians + 0.1, 0.0)
...
@patch('main.gym.make')
def test_run_simulation(mock_gym_make):
    # Setup mock env
    mock_env = MagicMock()
...
def test_main(mock_run_simulation):
    main()
